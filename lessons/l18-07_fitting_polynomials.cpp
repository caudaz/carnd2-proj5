...
// NOTE: compiled with    g++ -std=c++11

using namespace Eigen;

// Evaluates a polynomial of the form a3*x^3 + a2*x^2 + a1*x + a0 etc
...
int main() {
  ...
  // TODO: use `polyfit` to fit a third order polynomial to x,y coords
  auto coeffs = polyfit(xvals, yvals, 3);
  
  for (double x = 0; x <= 20; x += 1.0) {
    // TODO: use `polyeval` to evaluate the x values from 0 to 20
