...
// 1>sudo apt-get install gfortran             (takes about 5min)
// 2>Download version 3.12.7 from:
//   https://www.coin-or.org/download/source/Ipopt/Ipopt-3.12.7.tgz
// 3>tar -xvzf Ipopt-3.12.7.tgz
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  auto x_act = {solution.x[delta_start],   solution.x[a_start]};
  return {x_act};
}
